...
<body>
	<form method="POST" action="<?= $base_url ?>/users/updated">
		<table border="0" align="center">
			...
			<tr><td><input type="hidden" name="updated_at" value="<?= date('d/m/Y H:i:s'); ?>"></td></tr>
			<tr><td><input type="hidden" name="id" value="<?= $user->id ?>"></td></tr>
			<tr>
				<td></td>
				<td><input type="submit" name="submit" value="Submit">  <input type="submit" name="submit" value="Back"></td>
			</tr>
